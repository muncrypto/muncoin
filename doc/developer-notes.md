...
Mun Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Mun Core, where everyone uses
...
pay attention to for reviewers of Mun Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Mun Core uses tinyformat, which is type safe. Leave them out to avoid confusion
