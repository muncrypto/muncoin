...
This mechanism has been integrated into Bitcore-Node-Mun which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/munpay/insight-api-mun#web-socket-api](https://github.com/munpay/insight-api-mun#web-socket-api)
* API: [https://github.com/munpay/insight-api-mun#instantsend-transactions](https://github.com/munpay/insight-api-mun#instantsend-transactions)
...
By default, the Mun Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mun Core daemon:
