...
Only requiring some minor changes is mun.cpp.
...
Changes to mun.cpp
----------------------
mun.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
