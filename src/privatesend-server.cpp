...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Mun related functionality
...
/*
    ...
    allow endless transaction that would bloat Mun and make it unusable. To
