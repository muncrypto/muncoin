    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Mun Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Mun Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  mun-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Mun in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MUN, 0.1 MUN, 1 MUN and 10 MUN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://munpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://munpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Mun Core is shutting down...") + "<br /><br />" +
