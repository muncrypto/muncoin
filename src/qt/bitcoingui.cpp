    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Mun Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mun address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mun: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Mun Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mun Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mun Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mun addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mun addresses"));
    ...
    openAction->setStatusTip(tr("Open a mun: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mun Core help message to get a list with possible Mun Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Mun Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mun network", "", count));
    } else {
...
{
    QString strTitle = tr("Mun Core"); // default title
